...
describe('fizzbuzz', () => {
    ...
    /* por defecto se cubre con los otros
    ...
    it('should throw a specific error message if not number is provided as parameter', () => {
        expect(() => fizzbuzz()).toThrow('parameter provided must be a number')// this means /number/ that the result will find the word number inside the error message
    })
    ...
    /* test cubierto en test anterior de 1 o 2
